    ...
    def stringify_param(self, force=None):
        ...
        if isinstance(param, strings):
            ...
            try:
                ...
                logger.error(
                    'stringify_param was not able to get a proper repr for "{param}". This object will be reported as None. Add instructions for this object to DeepDiff\'s helper.literal_eval_extended to make it work properly: {err}'.format(param=param,err=err))
                result = None
            else:
