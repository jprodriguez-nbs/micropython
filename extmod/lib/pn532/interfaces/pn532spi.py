...
from pn532.interfaces.pn532Interface import Pn532Interface, PN532_ACK_WAIT_TIME, PN532_INVALID_FRAME, PN532_PN532TOHOST, \
...
class Pn532Spi(Pn532Interface):
    ...
    def __init__(self, ss: int, spi_device):
        self._command = 0
        self._ss = ss
