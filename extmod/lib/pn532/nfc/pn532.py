...
from pn532.interfaces.pn532Interface import Pn532Interface, PN532_TIMEOUT

# PN532 Commands
from pn532.nfc.pn532_log import DMSG, DMSG_HEX
...
class Pn532_Generic:
    ...
    def getFirmwareVersion(self) -> int:
        ...
        fw_ver = struct.unpack('>I',response)[0]
        return fw_ver
    ...
    def felica_RequestService(self, nodeCodeList):# -> (int, List[int]):
        """
    ...
    def felica_ReadWithoutEncryption(self, serviceCodeList, blockList):
    ...
    def felica_WriteWithoutEncryption(self, serviceCodeList, blockList, blockData) -> int:
