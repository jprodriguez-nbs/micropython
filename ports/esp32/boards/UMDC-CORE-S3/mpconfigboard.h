#define MICROPY_HW_BOARD_NAME "CORE-S3 CNX-umdc"
#define MICROPY_HW_MCU_NAME "ESP32S3"
#define MICROPY_PY_NETWORK_HOSTNAME_DEFAULT "umdccores3"
...
#define MICROPY_HW_SPI1_MOSI                (37)
#define MICROPY_HW_SPI1_MISO                (35)
